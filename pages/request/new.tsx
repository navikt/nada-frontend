...
import {NewAccessRequest, SubjectType, useDatasetQuery, useUserInfoDetailsQuery} from '../../lib/schema/graphql'
...
const AccessRequestNew = () => {
    ...
    return (
        <>
            ...
            <NewAccessRequestForm dataset={data.dataset} newAccessRequest={defaultValues}/>
        </>
    )
}
