...
export type DataproductQuery = {
  ...
  dataproduct: {
    ...
    datasets: Array<{
      ...
      services: { __typename?: 'DatasetServices'; metabase?: string | null }
      owner: {
        __typename?: 'Owner'
        group: string
        teamkatalogenURL?: string | null
...
export type GcpGetColumnsQuery = {
  __typename?: 'Query'
  gcpGetColumns: Array<{
    __typename?: 'TableColumn'
    name: string
  ...
  search: Array<{
    ...
    result:
      | {
          ...
          keywords: Array<string>
          slug: string
          datasets: Array<{ __typename?: 'Dataset'; name: string }>
          owner: {
            __typename?: 'Owner'
            group: string
            teamkatalogenURL?: string | null
 ...
 * });
 */
export function useGcpGetColumnsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GcpGetColumnsQuery,
    GcpGetColumnsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GcpGetColumnsQuery, GcpGetColumnsQueryVariables>(
    GcpGetColumnsDocument,
    options
  )
}
export function useGcpGetColumnsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GcpGetColumnsQuery,
    GcpGetColumnsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GcpGetColumnsQuery, GcpGetColumnsQueryVariables>(
    GcpGetColumnsDocument,
    options
  )
}
export type GcpGetColumnsQueryHookResult = ReturnType<
  typeof useGcpGetColumnsQuery
>
export type GcpGetColumnsLazyQueryHookResult = ReturnType<
  typeof useGcpGetColumnsLazyQuery
>
export type GcpGetColumnsQueryResult = Apollo.QueryResult<
  GcpGetColumnsQuery,
  GcpGetColumnsQueryVariables
>
 ...
 * });
 */
export function useProductAreaQuery(
  baseOptions: Apollo.QueryHookOptions<
    ProductAreaQuery,
    ProductAreaQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ProductAreaQuery, ProductAreaQueryVariables>(
    ProductAreaDocument,
    options
  )
}
export function useProductAreaLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ProductAreaQuery,
    ProductAreaQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ProductAreaQuery, ProductAreaQueryVariables>(
    ProductAreaDocument,
    options
  )
}
export type ProductAreaQueryHookResult = ReturnType<typeof useProductAreaQuery>
export type ProductAreaLazyQueryHookResult = ReturnType<
  typeof useProductAreaLazyQuery
>
export type ProductAreaQueryResult = Apollo.QueryResult<
  ProductAreaQuery,
  ProductAreaQueryVariables
>
 ...
 * });
 */
export function useProductAreasQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ProductAreasQuery,
    ProductAreasQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ProductAreasQuery, ProductAreasQueryVariables>(
    ProductAreasDocument,
    options
  )
}
export function useProductAreasLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ProductAreasQuery,
    ProductAreasQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ProductAreasQuery, ProductAreasQueryVariables>(
    ProductAreasDocument,
    options
  )
}
export type ProductAreasQueryHookResult = ReturnType<
  typeof useProductAreasQuery
>
export type ProductAreasLazyQueryHookResult = ReturnType<
  typeof useProductAreasLazyQuery
>
export type ProductAreasQueryResult = Apollo.QueryResult<
  ProductAreasQuery,
  ProductAreasQueryVariables
>
