...
export const ExploreLink = ({
  ...
  if (url) {
    return (
      <a
        className="w-64 p-3 bg-white, border-[1px] border-border rounded-md no-underline"
        href={url}
        target="_blank"
        rel="noreferrer"
      >
  ...
  if (isOwner) {
    if (loading) {
      return (
        <a
          className="w-64 p-3 bg-white, border-[1px] border-border rounded-md no-underline cursor-default"
          href="#"
          onClick={add}
          loading={true}
        >
