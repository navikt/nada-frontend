...
const ViewDataset = ({ dataset, dataproduct, accessType, userInfo, isOwner, setEdit }: ViewDatasetProps) => {
    ...
    return <>
        ...
        <div className="block pt-8 pr-8">
            ...
            <div className="flex items-center gap-4 mb-2">
                ...
                {isOwner && <DatasetOwnerMenu datasetName={dataset.name} datasetId={dataset.id} dataproduct={dataproduct} setEdit={setEdit} />}
            </div>
            {dataset.pii
